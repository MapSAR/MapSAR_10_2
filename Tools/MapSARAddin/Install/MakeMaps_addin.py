...
class ClearSpatialReference(object):
    """Implementation for Clear_Spatial_Reference_MakeMaps_addin.button (Button)"""
    def __init__(self):
        self.enabled = True
        self.checked = False
    def onClick(self):
        pythonaddins.GPToolDialog(SAR_MaintenancePath, 'SetSRUnknown')
...
class Create_MapSAR_New_button(object):
    ...
    def __init__(self):
        ...
        self.checked = False
    def onClick(self):
        pythonaddins.GPToolDialog(SAR_MaintenancePath, 'CreateLocalizedMapSAR')
