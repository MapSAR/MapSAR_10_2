cscript msgbox.vbs "Message for 10.2" "This script will install all nesesssary MapSAR add-ins for ArcMap 10.2, click OK to continue"{cr}""{cr}" Please assure ArcMap is closed !" "1"
